<template>
    <view class="mpvue-picker">
        ...
        <view class="mpvue-picker-content flex-direction" :class="{'mpvue-picker-view-show':showPicker}">
            <view class="mpvue-picker__hd align-center" catchtouchmove="true">
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange" v-if="mode==='selector' && pickerValueSingleArray.length > 0">
                <block>
                    <picker-view-column>
                        <view class="picker-item justify-center align-center" v-for="(item,index) in pickerValueSingleArray" :key="index">
                            <view 
                            v-if="item.label == '无需餐具'"
                            class="flex-direction align-center"
