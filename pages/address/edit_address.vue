...
<script>
	export default {
		...
		created() {
            ...
            this.formData.name = this.my_address[this.editIndex].name;
            this.formData.gender = this.my_address[this.editIndex].gender;
            this.formData.phone = this.my_address[this.editIndex].phone;
            this.formData.address = {position_address:this.my_address[this.editIndex].address};
            this.formData.addressInfo = '无默认值，可随意更改';
            this.formData.tag = this.my_address[this.editIndex].tag;
		...
		methods:{
            ...
            confirm(done){
                ...
                // 执行删除过程
                this.my_address.splice(this.editIndex,1);
                this.editIndex = null;
			...
			formSubmit(e){
				...
				this.my_address[this.editIndex] = {
